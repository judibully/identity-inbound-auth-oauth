...
public class NotBeforeWithOffsetIDTokenBuilder implements IDTokenBuilder {
    ...
    private static final Log log = LogFactory.getLog(NotBeforeWithOffsetIDTokenBuilder.class);
    private JWSAlgorithm signatureAlgorithm;
    private JWEAlgorithm encryptionAlgorithm;
    private EncryptionMethod encryptionMethod;

    public NotBeforeWithOffsetIDTokenBuilder() throws IdentityOAuth2Exception {
    ...
    public String buildIDToken(OAuthTokenReqMessageContext tokenReqMsgCtxt,
        ...
        // FLOWBIRD PATCH ------------------------------------------------------------------
        // -DnotBeforeTimeOffset=30000 expected as JVM argument
        long notBeforeTimeOffsetValue = 30000; // default to 30 seconds
        String notBeforeTimeOffsetProperty = System.getProperty("notBeforeTimeOffset");
        if (notBeforeTimeOffsetProperty != null && !notBeforeTimeOffsetProperty.isEmpty()) {
            try {
